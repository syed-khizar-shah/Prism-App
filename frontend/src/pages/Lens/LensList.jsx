          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Create, manage, and monitor lens options for your products
              </p>
            </div>
          ...
          <div className="p-6 border-b border-gray-100">
            <div className="flex flex-col space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <h2 className="text-xl font-medium text-gray-900">Lenses</h2>
                  <p className="text-sm text-gray-500 mt-1">Manage lens options for your products</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            ...
            {filteredLenses.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-sm">No lenses found</p>
                <p className="text-gray-400 text-xs mt-1">
                  {searchTerm ? 'Try adjusting your search terms' : 'Create your first lens to get started'}
                </p>
              </div>
            )}
          </div>
